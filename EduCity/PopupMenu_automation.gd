...
func _on_lesson1Button_pressed():
	GameManager.reading_path = "res://LearningResources/IBM Automation/IBM Robotic Process Automation - Basic I/IBM Robotic Process Automation - Basic I.md"
	get_tree().change_scene_to_file("res://reading_scene.tscn")


func _on_quiz1Button_pressed():
	GameManager.question_path = "res://LearningResources/IBM Automation/IBM Robotic Process Automation - Basic I/Quiz-IBM Robotic Process Automation - Basic I.json"
